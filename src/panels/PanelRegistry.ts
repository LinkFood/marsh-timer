...
export const PANEL_REGISTRY: PanelDef[] = [
  ...
  { id: 'admin-console', label: 'Admin Console', category: 'analytics', description: 'System health, cron status, web discoveries', defaultW: 6, defaultH: 6, component: lazy(() => import('./AdminConsolePanel')), refreshInterval: 'real-time', dataSourceCount: 14, dataSources: ['All Crons'] },
  { id: 'pattern-timeline', label: 'Pattern Timeline', category: 'analytics', description: 'Historical pattern matches for current conditions', defaultW: 4, defaultH: 5, component: lazy(() => import('./PatternTimelinePanel')), refreshInterval: 'on-demand', dataSourceCount: 21, dataSources: ['Brain Search'] },
