...
export const PANEL_REGISTRY: PanelDef[] = [
  ...
  { id: 'hunt-alerts', label: 'Pattern Alerts', category: 'intelligence', description: 'Proactive environmental pattern alerts', defaultW: 3, defaultH: 3, component: lazy(() => import('./HuntAlertsPanel')), refreshInterval: 'daily', dataSourceCount: 3, dataSources: ['Open-Meteo', 'Brain Search', 'Convergence Engine'] },
  ...
  { id: 'state-profile', label: 'State Profile', category: 'intelligence', description: 'State-level environmental intelligence', defaultW: 4, defaultH: 5, component: lazy(() => import('./StateProfilePanel')), refreshInterval: 'daily', dataSourceCount: 5, dataSources: ['Convergence Engine', 'Open-Meteo', 'eBird', 'Solunar', 'State Regulations'] },
  ...
  { id: 'solunar', label: 'Solunar', category: 'weather', description: 'Moon/sun data', defaultW: 3, defaultH: 3, component: lazy(() => import('./SolunarPanel')), refreshInterval: 'weekly', dataSourceCount: 1, dataSources: ['Solunar Calendar'] },
