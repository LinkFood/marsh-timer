-- Fix v3 RPC: add SET LOCAL ivfflat.probes = 40 for IVFFlat index
-- The DB uses IVFFlat, NOT HNSW. Previous fix removed hnsw.ef_search but
-- didn't add ivfflat.probes — so the index was running with default probes (1).
