-- Fix: 1) recency weight exp() underflow for old entries (clamp age to 365 days)
--      2) use subquery pattern for IVFFlat index scan (ORDER BY in inner, threshold in outer)
